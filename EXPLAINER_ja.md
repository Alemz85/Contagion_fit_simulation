...
### でも待って — それは不公平な勝負だった（図F8）⚖️

**人気者1人 vs ランダム1人**の比較はズルい。人気者が勝つに決まっている。本当のマーケ
ティングの問いはこうだ：*予算が決まっているとき*、**1人の有名人**を買うべきか、それとも
**安い一般アカウントの群れ**を買うべきか？現実では有名人は無名の人よりずっと高い。そこで
全戦略に**同じ予算**を与え、**有名さを高価**にした（ハブ1人 ≈ 一般アカウント約12個分の値段）。

```
  予算 = 15コイン
  有名人:  [ハブ] 値段15  -> 種を1個しか置けない
  群れ:    [o][o][o][o][o][o][o][o] 1個あたり約1 -> 約8個置ける
```

5つの戦略を競わせた——有名人(hub)、賢い標的型2種、素朴な**ランダムの群れ**、そして
シミュレータで最良の組み合わせを探す**貪欲プランナー**——指標は「**1コインあたり何人に
届くか**」。

![F8 予算の比較 — 単純伝播](results/F8_budget_cost_ic.png)

> 🏆 **単純伝播（ニュース型）では群れが勝つ。** 有名人1人は全予算で約9人にしか届かないが、
> 同じ予算で約7–8個の一般アカウントを買えば約14人に届く。さらに、誰でも選べる貪欲プランナーは
> **自力で安い群れを選び**、ここでは有名人が金の無駄だと裏づける。
> **これはまさに有名な「分散した群衆が1人の大物インフルエンサーに勝つ」という主張**
> （Watts & Dodds）であり、上の1対1の実験では決して見えなかったもの。

**複雑伝播**（数人の友達がやってから参加するタイプ）では逆になる。火をつけるには的確な
位置に種が要るので標的型がリーチで勝ち、ランダムの群れは時に立ち消える。だから誠実な
ヘッドラインは：**ニュース型の拡散では安い群れが有名人に勝つが、仲間の後押しが要る行動
には勝てない。**
